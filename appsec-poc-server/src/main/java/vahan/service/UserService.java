...
import vahan.auth.JwtAuthenticationController;
import vahan.auth.JwtTokenUtil;
import vahan.dao.paidnrv.StakeholderDAO;
...
public class UserService {
    ...
    @Autowired
    VerificationTokenRepository verifictionTokenRepository;
    ...
    public ApiResponse readUser(String userId, String id, String integrityToken, String client) throws IllegalArgumentException, IOException, InterruptedException, ParseException {

        if (integrityCheckPassed(integrityToken, client)) {
    ...
    private boolean integrityCheckPassed(String integrityToken, String client)
        ...
        // TokenPayloadExternal tokenPayloadExternal = mapper.convertValue(responseBody, TokenPayloadExternal.class);

        Map<String,Object> tokenPayloadExternal = mapper.convertValue(responseBody.get("tokenPayloadExternal"), Map.class);
        ...
        Map<String,List<String>> deviceIntegrity = mapper.convertValue(tokenPayloadExternal.get("deviceIntegrity"), Map.class);
